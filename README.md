...
[![CircleCI](https://circleci.com/gh/gravitee-io/gravitee-policy-http-callout.svg?style=svg)](https://circleci.com/gh/gravitee-io/gravitee-policy-http-callout)
...
## Phases
The phases checked below are supported by the `policy-http-callout` policy:
...
*V4 API with basic callout*
```json
{
  "api": {
    "definitionVersion": "V4",
    "type": "PROXY",
    "name": "HTTP Callout Example v4 API",
    "flows": [
      {
        "name": "Common Flow",
        "enabled": true,
...
```
*V4 API CRD with basic callout*
```yaml
apiVersion: "gravitee.io/v1alpha1"
kind: "ApiV4Definition"
metadata:
    name: "policy-http-callout-proxy-v4-api-crd"
spec:
    name: "HTTP Callout example with V4 API CRD"
    type: "PROXY"
    flows:
      - name: "Common Flow"
        enabled: true
